...
{   
    ...
    $settings->add(new admin_setting_configtext('enrol_duitku/merchantcode', get_string('merchantcode', 'enrol_duitku'), get_string('merchantcode_desc', 'enrol_duitku'), '', PARAM_TEXT));

    $options = [
        'sandbox' => get_string('environment:sandbox', 'enrol_duitku'),
        'production' => get_string('environment:production', 'enrol_duitku')
    ];
    $settings->add(new admin_setting_configselect('enrol_duitku/environment', get_string('environment', 'enrol_duitku'), get_string('environment_desc', 'enrol_duitku'), 'sandbox', $options));

    $settings->add(new admin_setting_configtext('enrol_duitku/expiry', get_string('expiry', 'enrol_duitku'), get_string('expiry_desc', 'enrol_duitku'), 10, PARAM_INT));
    ...
    $settings->add(new admin_setting_configselect('enrol_duitku/expiredaction', get_string('expiredaction', 'enrol_duitku'), get_string('expiredaction_help', 'enrol_duitku'), ENROL_EXT_REMOVED_SUSPENDNOROLES, $options));
    ...
    $settings->add(new admin_setting_confightmleditor('enrol_duitku/admin_email', get_string('admin_email', 'enrol_duitku'), get_string('admin_email_desc', 'enrol_duitku'), '', PARAM_RAW));
    $settings->add(new admin_setting_confightmleditor('enrol_duitku/teacher_email', get_string('teacher_email', 'enrol_duitku'), get_string('teacher_email_desc', 'enrol_duitku'), '', PARAM_RAW));
    $settings->add(new admin_setting_confightmleditor('enrol_duitku/student_email', get_string('student_email', 'enrol_duitku'), get_string('student_email_desc', 'enrol_duitku'), '', PARAM_RAW));
